...
Func Web1_OnMessageReceived($sMsg)
	...
	If $sMsg = "INIT_READY" Then $oWeb1.NavigateToString(_GetDemoHTML("Browser 1 Content"))
...
Func Web2_OnMessageReceived($sMsg)
	...
	If $sMsg = "INIT_READY" Then $oWeb2.NavigateToString(_GetDemoHTML("Browser 2 Content"))
